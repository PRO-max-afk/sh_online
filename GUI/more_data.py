            ...
            if filename.lower().endswith((".ttf", ".otf",".TTF")):
                ...
                if font_id == -1:
                    ...
                    if families:
                        pass
    ##
    def set_info(self, brand,weight,pro_date,pro_state,more,keep,place):
        self.brand_line.setText(brand)
        self.weight_line.setText(weight)
        self.pro_date_line.setText(pro_date)
        self.state_line.setText(pro_state)
        self.more_detials.setText(more)
        self.place_st_line.setText(keep)
        self.palce_line.setText(place)
