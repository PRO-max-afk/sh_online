...
class Notifi_Change(QWidget):
    def __init__(self, parent=None):
        ...
        self.load_all_fonts()
        self.barcode= ""
        self.product_data = None  # ذخیره اطلاعات محصول
        ...
        self.na_lb = QLabel("")
        self.number_lb = QLabel("بارکد محصول:")
        self.nu_lb = QLabel("")
        self.expire_date = QLabel("تاریخ انقضاء:")
        self.exp_lb = QLabel("")
        self.text_lb= QLabel("محصولات رد شده")
        ...
        ch_icon= QIcon(self.get_asset_path("return-box_7646459.png"))
        self.change_btn.setIcon(ch_icon)
        self.change_btn.setText("تغییر محصول")
        self.change_btn.setIconSize(QtCore.QSize(25,25))
        self.change_btn.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        self.change_btn.clicked.connect(self.open_form)
        ...
        info_layout.addWidget(self.change_btn)
    ...
    def open_form(self):
        ...
        del_dialog = ProductForm(product_data=self.product_data)
        del_dialog.set_info(self.barcode)
        del_dialog.exec()
    ##
