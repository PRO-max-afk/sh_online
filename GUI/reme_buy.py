...
class Customer_Buy(QWidget):
    def __init__(self, parent=None):
        ...
        self.frame.setStyleSheet("background-color: #56B2E3; border-radius: 12px;")
        ...
        self.number_label = QLabel("1200")

        self.text_label = QLabel("مجموعه قرض")
